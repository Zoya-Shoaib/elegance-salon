...
class AdminController extends Controller
{
    ...
    function pos_checkout()
    {
        ...
        $clients = Client::all();
        $staff = Staff::all();
        $orders = Orders::with(['client', 'stylist', 'service1', 'service2', 'service3'])->latest()->get();

        return view('admin.pos-checkout', compact('services', 'clients', 'staff', 'orders'));
    }
    ...
    function services()
    {
        ...
        $services = Service::all();
        return view('admin.services', compact('products', 'services'));
    }
}
